    ...
    ERC721Upgradeable
{
        ...
        onlyWhenNotPaused(tokenId)
    {
        ...
        emit AddAndRemoveRanges(tokenId, _tempVault, addRanges, removeRanges);
    }
        ...
        isAuthorizedForToken(tokenId)
    {
        ...
        emit RemoveRangesAllLiquidityFromPosition(tokenId, _tempVault, ranges);
    }
        ...
        onlyProviderOrManager(tokenId)
    {
        ...
        emit PauseCHI(tokenId, _tempVault);
    }
