...
interface IYANGDepositCallBackInterface extends ethers.utils.Interface {
  functions: {
...
export class IYANGDepositCallBack extends BaseContract {
  ...
  interface: IYANGDepositCallBackInterface;
