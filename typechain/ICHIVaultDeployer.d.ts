...
interface ICHIVaultDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class ICHIVaultDeployer extends BaseContract {
  ...
  interface: ICHIVaultDeployerInterface;
