...
interface YangNFTVaultV2Interface extends ethers.utils.Interface {
  functions: {
...
export class YangNFTVaultV2 extends BaseContract {
  ...
  interface: YangNFTVaultV2Interface;
  ...
  functions: {
    ...
    rewardProxy(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    rewardProxy(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    rewardProxy(overrides?: CallOverrides): Promise<PopulatedTransaction>;
